  ...
  return (
    <div className='mx-auto flex w-[70%] items-center justify-center md:w-full'>
      <div className='flex flex-col items-center justify-center gap-2'>
        <p className={`text-xxs ${step1 ? 'text-secondary-brown-light' : 'text-gray-300'}`}>STEP 01</p>
      ...
      <div className='flex flex-col items-center justify-center gap-2'>
        ...
        <p className={`text-xs ${step3 ? 'text-secondary-brown-light' : 'text-gray-300'}`}>送信完了</p>
      </div>
    </div>
  )
}
