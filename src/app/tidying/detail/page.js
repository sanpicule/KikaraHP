            ...
            <div className='mt-12 grid grid-cols-2 gap-12'>
              <div className='relative rounded-xl border-2 border-secondary-brown p-8'>
                ...
                <div className='mt-8'>
                  ...
                  <div className='ml-8 flex flex-col gap-4'>
                    <h4 className='mt-2'>
                      <span className='text-4xl tracking-normal text-secondary-brown-light'>15,000円</span>/180分
                      <br></br>(出張費・税込)
                    </h4>
              ...
              <div className='rounded-xl border-2 border-secondary-brown p-8'>
                ...
                <div className='mt-8'>
                  ...
                  <div className='ml-8 flex flex-col gap-4'>
                    <h4>
                      <span className='text-4xl tracking-normal text-secondary-brown-light'>8,000円</span>/90分<br></br>
                      (出張費・税込)
                    </h4>
